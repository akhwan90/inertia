            ...
            <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
                <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg dark:bg-gray-800">
                    ...
                    <div class="p-4">
                        ...
                        <div class="overflow-x-auto mt-4">
                            <table class="dark:text-white w-full">
                                ...
                                <tbody>
                                    <tr v-for="item in pemeriksaanKategoris.data" :key="item.id">
                    ...
                    <div class="my-4 mx-4 flex gap-2">
                        <button v-for="link in pemeriksaanKategoris.links" :key="link.label" @click="fetchData(link.url)"
...
export default {
    ...
    methods: {
        ...
        saveUser() {
            if (this.isEdit) {
                router.put(`/admin/pemeriksaankategori/${this.form.id}`, this.form, {
                    onSuccess: () => this.closeModal(),
                });
            } else {
                router.post("/admin/pemeriksaankategori", this.form, {
                    onSuccess: () => this.closeModal(),
                });
            }
        },
        deleteUser(id) {
            if (confirm("Apakah Anda yakin ingin menghapus user ini?")) {
                router.delete(`/admin/pemeriksaankategori/${id}`);
            }
        },
    }
};
